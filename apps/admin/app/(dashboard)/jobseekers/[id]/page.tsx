...
export default function JobseekerDetailPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Header */}
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-4 sm:px-6 lg:px-10 py-4 sm:py-6 bg-white border-b border-slate-100">
        <div className="flex items-center gap-4">
          <Link
            href="/jobseekers"
            className="p-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-600 transition-colors border border-slate-100"
          >
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400 font-medium">
              ID: <span className="font-mono text-slate-600">#{jobseeker.id}</span>
            </p>
          </div>
        </div>
