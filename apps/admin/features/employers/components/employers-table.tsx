...
const mockEmployers: Employer[] = [
  ...
  },
  {
    ...
    type: "Company",
    contactPerson: "Amara Okoro",
    industry: "Renewable Energy",
    location: "Nairobi",
    status: "Active",
    verification: "Verified",
    joinedOn: "Feb 05, 2025",
  },
  {
    id: "3",
    companyName: "Abdisa Leta",
    type: "Individual",
    contactPerson: "Abdisa Leta",
    industry: "Residential Construction",
    location: "Addis Ababa",
    status: "Active",
    verification: "Verified",
    joinedOn: "Mar 01, 2025",
  },
  {
    id: "4",
...
export function EmployersTable() {
  ...
  const filteredEmployers = mockEmployers.filter(
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-slate-50 bg-white">
          <p className="text-[11px] font-bold text-slate-500 italic">
            ...
            <span className="text-slate-800">
              1 to {filteredEmployers.length}
            </span>{" "}
            of <span className="text-slate-800">1,200</span>
          </p>
