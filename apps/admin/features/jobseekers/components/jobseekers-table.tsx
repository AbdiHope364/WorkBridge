...
const mockJobseekers: Jobseeker[] = [
  ...
  },
  {
    ...
    phone: "+2519000001",
    skills: ["Python", "Django", "PostgreSQL", "+3"],
    status: "Active",
    verification: "Verified",
    joinedOn: "June, 15, 2025",
  },
  {
    id: "4",
    name: "John Doe",
  ...
  },
  {
    ...
    phone: "+2519000003",
    skills: ["PHP", "Laravel", "SQLite", "+1"],
    status: "Active",
    verification: "Verified",
    joinedOn: "August, 30, 2025",
  },
];
...
export function JobseekersTable() {
  ...
  const handleAction = (reason: string) => {
    ...
    console.log(
      `${activeModal?.type} user ${activeModal?.id} with reason: ${reason}`,
    );
    setActiveModal(null);
  };
    ...
    <div className="px-10 pb-10">
      <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <ActionModal
          ...
          title={
            activeModal?.type === "suspend" ? "Suspend User" : "Delete User"
          }
          description={
                  ...
                  <div
                    className={cn(
                      ...
                      jobseeker.verification === "Verified"
                        ? "bg-emerald-50 text-emerald-600"
                        : jobseeker.verification === "Pending"
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-slate-50 bg-white">
          <p className="text-[11px] font-bold text-slate-500 italic">
            Showing <span className="text-slate-800">1 to 5</span> of{" "}
            <span className="text-slate-800">12,845</span>
          </p>
