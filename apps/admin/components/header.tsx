...
export function Header() {
  return (
    <header className="flex items-center justify-between px-10 py-5 bg-transparent">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 leading-tight">Hello, Admin</h1>
        <p className="text-slate-500 font-medium text-sm">Welcome back to Workbridge admin dashboard</p>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-xl border border-slate-100 shadow-sm cursor-pointer hover:border-slate-300 transition-colors">
          ...
          <span className="text-sm font-semibold text-slate-700">All period</span>
