...
const categories = [
  {
    ...
    badge: "Emergency",
    icon: Wrench,
    description: "Water pipe leaks, drainage, water tanks & bathroom fixtures",
    count: "520+ artisans",
  },
  {
    ...
    badge: "High Demand",
    icon: Zap,
    description: "Household wiring, breakers, light fixtures & generator repair",
    count: "640+ electricians",
  },
  {
    name: "Appliance Repair",
    badge: "Essential",
    icon: Flame,
    description: "Refrigerators, washing machines, stoves & home electronics",
    count: "380+ technicians",
  },
  {
    name: "House Painting & Wall Fix",
    badge: "Popular",
    icon: Paintbrush,
    description: "Interior & exterior wall painting, plastering & drywall repair",
    count: "410+ painters",
  },
  {
    ...
    badge: "Handyman",
    icon: Hammer,
    description: "Door locks, custom wooden cabinets, furniture repair & assembly",
    count: "310+ carpenters",
  },
  {
    name: "Cleaning & Sanitation",
    badge: "Active",
    icon: Sparkles,
    description: "Residential deep home cleaning, compound care & sanitation",
    count: "450+ housekeepers",
  },
];
