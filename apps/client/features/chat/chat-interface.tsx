...
const INITIAL_CONVERSATIONS: ConversationItem[] = [
  {
    ...
    isOnline: true,
    verified: true,
    preview: "Hi Abdi, we have reviewed your portfolio and would like to schedule a technical sync next week...",
    timeLabel: "10:45 AM",
    unreadCount: 2,
    category: "interviews",
    ...
    messages: [
      {
        ...
        sender: "them",
        senderName: "Usmael Taju",
        text: "Hello Abdi! We thoroughly reviewed your WorkBridge profile and trade certifications for the High-Voltage Substation upgrade at our Addis Campus.",
        timestamp: "10:30 AM",
        read: true,
      },
      {
    ...
    messages: [
      {
        ...
        sender: "them",
        senderName: "Sarah Jenkins",
        text: "Good morning Abdi! We received your quote for the 30kW rooftop solar array in Kazanchis.",
        timestamp: "09:00 AM",
        read: true,
      },
      {
    ...
    messages: [
      {
        ...
        sender: "them",
        senderName: "Robel Haile",
        text: "Abdi, the HVAC ventilation ducting installation at the Bole Medhanialem complex passed the municipal pressure test!",
...
const AUTO_REPLY_BANK: Record<string, string[]> = {
  "usmael-google": [
    "Sounds great, Abdi! I've marked the video meeting on Google Meet. Looking forward to speaking with you.",
