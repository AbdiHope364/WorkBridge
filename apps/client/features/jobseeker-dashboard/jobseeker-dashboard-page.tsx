...
export function JobseekerDashboardPage() {
  ...
  const metrics = [
    {
      label: "Applied",
      value: analytics?.cards?.applied || 0,
      icon: "applied",
    },
    {
      label: "In Review",
      value: analytics?.cards?.inReview || 0,
      icon: "review",
    },
    {
      label: "Accepted",
      value: analytics?.cards?.accepted || 0,
      icon: "accepted",
    },
    {
      label: "Rejected",
      value: analytics?.cards?.rejected || 0,
      icon: "rejected",
    },
  ];
          ...
          <header className="flex h-20 items-center justify-between border-b border-slate-200 bg-white px-6 md:px-10">
            ...
            <div className="flex items-center gap-5">
              ...
              <Link href="/dashboard/notifications">
                <BellIcon className="w-5 h-5 text-slate-400 hover:text-teal-600" />
              </Link>
              ...
              {metrics.map((metric, idx) => (
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center text-center">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 ${metricIconClasses[metric.icon]}`}
                    >
                    ...
                    <strong className="text-4xl font-black text-slate-900 tracking-tighter">
                      {metric.value}
                    </strong>
                  ...
                  <div>
                    ...
                    <div className="h-2 rounded-full bg-slate-100 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: analytics?.profileViews ? "80%" : "0%",
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="h-2 rounded-full bg-slate-100 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: analytics?.resumeDownloads ? "40%" : "0%",
                        }}
                      />
                    </div>
                  </div>
