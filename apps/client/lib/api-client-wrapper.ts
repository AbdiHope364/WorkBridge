...
export function createJobsService(api: ApiClient) {
  ...
  return {
    ...
    getJobseekerDashboard: async (): Promise<unknown> =>
      api.request("/jobs/jobseeker/dashboard"),
...
export function createEmployerProfileService(api: ApiClient) {
  return {
    getMyProfile: () => api.request("/profiles/employer/me"),
    ...
    createCompanyProfile: (data: object) =>
      api.request("/profiles/employer/company", { method: "POST", body: data }),
    createMyIndividualProfile: (data: object) =>
      api.request("/profiles/employer/individual", { method: "POST", body: data }),
    updateCompanyProfile: (data: object) =>
      api.request("/profiles/employer/company", { method: "PUT", body: data }),
    updateMyIndividualProfile: (data: object) =>
      api.request("/profiles/employer/individual", { method: "PUT", body: data }),
    uploadAvatar: (file: File) =>
      api.request("/profiles/employer/avatar", { method: "POST", body: file }),
    uploadLogo: (file: File) =>
      api.request("/profiles/employer/logo", { method: "POST", body: file }),
    uploadBanner: (file: File) =>
      api.request("/profiles/employer/banner", { method: "POST", body: file }),
  };
}
...
export function createJobseekerProfileService(api: ApiClient) {
  return {
    getMyProfile: () => api.request("/profiles/jobseeker/me"),
    getByUser: async (userId: string) => {
    ...
    createProfile: (data: object) =>
      api.request("/profiles/jobseeker", { method: "POST", body: data }),
    updateMyProfile: (data: object) =>
      api.request("/profiles/jobseeker/me", { method: "PUT", body: data }),
    uploadAvatar: (file: File) =>
      api.request("/profiles/jobseeker/avatar", { method: "POST", body: file }),
  };
}
